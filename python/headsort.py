...
class App(tkinter.Tk):
    ...
    def github(self):
        lien_github = (
            "https://github.com/Angel-Dijoux/tri_par_tas/blob/main/headsort.py"
        )
    ...
    def widgets(self):
        ...
        # calls tri_tas class
        self.button_tri = tkinter.Button(
            self.frame_result,
            text="Trie",
            bg="#EBEBEB",
            fg="#2E3138",
            activebackground="#F76C5E",
            activeforeground="#2E3138",
            command=self.tri_par_tas,
        )
